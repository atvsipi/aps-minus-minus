...
export class World extends EventEmitter {
    ...
    protected handleDynamicCollision(entity: Entity, other: Entity): void {
        ...
        if ((entity.setting.bullet || other.setting.bullet) && !(entity.setting.hardBullet && other.setting.hardBullet)) {
            return;
        }
    ...
    protected resolveElasticCollision(entity: Entity, other: Entity): void {
        ...
        const overlap = (entity.size + other.size) * 0.6 - Vector.distance(entity.pos, other.pos);
